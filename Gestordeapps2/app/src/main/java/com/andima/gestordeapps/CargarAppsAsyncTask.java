...
/**
 * Created by Andima on 29/04/2018.
 */

public class CargarAppsAsyncTask extends AsyncTask<String, Void, List<App>> {

    private boolean incluirInstaladas;
    private ListaAppsAbstractActivity activity;
    private boolean todas;

    public CargarAppsAsyncTask(ListaAppsAbstractActivity pActivity) {
        activity = pActivity;
    }
    ...
    protected List<App> doInBackground(String... strings) {
        ...
        Conexion con = new Conexion(activity.getApplicationContext());
                ...
                for (int i = 0; i < resultado.size(); i++) {
                    ...
                    if (!appsAIntrod.containsKey(jsonApp.get("paquete").toString())) {
                        ...
                        try {
                            ...
                            icono = new BitmapDrawable(activity.getResources(), BitmapFactory.decodeStream(imageStream));
